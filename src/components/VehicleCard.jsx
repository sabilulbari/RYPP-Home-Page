...
export default function VehicleCard({ vehicle, onBookNow }) {
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-4 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">
      <div>
      ...
      <button
        ...
        className="mt-4 w-full py-2.5 px-4 rounded-lg bg-[#FF1E36] hover:bg-[#E01B32] text-white font-semibold text-xs sm:text-sm flex items-center justify-center gap-1.5 shadow-sm hover:shadow-md transition-all active:scale-[0.98]"
      >
        <span>Book Now</span>
