  ...
  return (
    <footer id="footer" className="bg-[#0B0F19] text-gray-400 pt-12 lg:pt-16 pb-8 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-5 pb-12 border-b border-gray-800/80">
          {/* Col 1: Brand Info */}
          <div className="lg:col-span-1 space-y-4">
            <div className="items-center">
              <Image src="https://i.ibb.co.com/QjMbTZgP/rypp-logo-png-removebg-preview-1-1.png" alt="RYPP" width={60} height={60} className="ml-2" />
              <span className="text-3xl font-black text-white tracking-tight block">RYPP</span>
              <span className="text-xs font-script font-bold text-[#FF1E36] tracking-wide block">Ride Your Way.</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs font-medium">
              ...
              <li>
                <a href="#why-rypp" className="hover:text-white transition-colors">
                  About
                </a>
              </li>
              <li>
          ...
          <div >
            ...
            <ul className="space-y-3 text-xs font-medium">
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-[#FFff] shrink-0" />
                <span>+91 98765 43210</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-[#FFff] shrink-0" />
                <span>hello@rypp.in</span>
              </li>
              <li className="flex items-center gap-2.5">
                <MapPin className="w-4 h-4 text-[#FFff] shrink-0" />
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-gray-500">
          ...
          <p className="font-script text-sm text-gray-400">Ride Your Way. Explore More.</p>
        </div>
      </div>
    </footer>
  );
